package com.hhplu.hhplusconcert.app.common.error;
...
public enum ErrorCode {
    ...
    // Concert Errors
    CONCERT_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_C01", "존재하지 않는 콘서트입니다.", "Invalid request"),
    CONCERT_SCHEDULE_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_CS02", "콘서트 일정이 존재하지 않습니다.", "Invalid request"),

    // Point Errors
    POINT_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_POI01", "해당 잔액 정보를 찾을 수 없습니다.", "Invalid request"),
    POINT_BAD_RECHARGE_REQUEST(HttpStatus.BAD_REQUEST, "ERR_POI02", "잔액이 부족합니다.", "Invalid request"),
    ...
    // WaitingQueue Errors
    WAITING_QUEUE_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_WQ01", "해당 대기열을 찾을 수 없습니다.", "Invalid request"),
    ...
    SEAT_RESERVATION_FAILED(HttpStatus.BAD_REQUEST, "ERR_SE02", "좌석 예약에 실패했습니다. 다시 시도해 주세요.", "Invalid request"),
